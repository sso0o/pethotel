function drawBookingDetail(data) {
    ...
    <h3>${roomType} </h3>
    <p></p>
    <p>총 숙박 일 : ${searchData.room}객실 ${searchData.dateDiff}박 </p>
    ...
    <p></p>
    <h6>총 결제 금액</h6>
    <h5 style="color: red; font-weight: bold;"> ${ (roomPrice * searchData.dateDiff * searchData.room).toLocaleString() } 원</h5>
    <hr/>
